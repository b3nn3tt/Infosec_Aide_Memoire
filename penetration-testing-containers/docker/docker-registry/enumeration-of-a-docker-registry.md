...
![nmap scan results, showing a Docker registry running on default TCP 5000, and another on TCP 7000](<../../../.gitbook/assets/image (110).png>)
...
![A crafted GET request to the target Docker Registry](<../../../.gitbook/assets/image (124).png>)
...
![A crafted GET request to determine tags](<../../../.gitbook/assets/image (70).png>)
...
![Grabbing the manifest file](<../../../.gitbook/assets/image (116).png>)
