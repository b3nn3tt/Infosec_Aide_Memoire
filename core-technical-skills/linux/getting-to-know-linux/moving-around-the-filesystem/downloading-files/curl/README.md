...
![An example of curl in action](../../../../../../.gitbook/assets/image%20%2816%29.png)
...
![HTTP 301 redirect - curl merely displays the message and does not follow its instruction](../../../../../../.gitbook/assets/image%20%2815%29.png)

 The `-L` option instructs `curl` to follow any redirect until it reaches the final destination:

![The original HTTP 301 as above, followed by an example of following the redirect](../../../../../../.gitbook/assets/image%20%2829%29.png)
