...
![Ubuntu default installation, where root has no password set](../../../../../.gitbook/assets/image%20%2841%29.png)
...
![A user, as a member of the sudo group, is able to switch to the root account via sudo su](../../../../../.gitbook/assets/image%20%2840%29.png)
